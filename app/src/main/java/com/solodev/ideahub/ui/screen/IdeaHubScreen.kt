...
import com.solodev.ideahub.ui.screen.userThreadScreen.ThreadDetailsScreen
...
fun IdeaHubScreen(
    ...
    var selectedItem by rememberSaveable { mutableStateOf(0) }
     val threadViewModel: UserThreadViewModel = hiltViewModel()
            ...
            screenContent = {
                GeneralThreadListContent (
                    ...
                    onThreadClick = {
                        ...
                        navController.navigate(Routes.UserThreadScreen.name)
                    }
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(
                route = Routes.UserThreadScreen.name
